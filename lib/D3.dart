  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // ignore: prefer_const_constructors
        title: Text('Benign keratosis-like lesions [bkl]:'),
                  ...
                  Container(
                    child: Column(
                      children: <Widget>[
                        ...
                        const Text(
                          "Benign keratosis is a generic class that includes seborrheic ker- atoses senile wart, solar lentgo - which can be regarded a flat variant of seborrheic keratosis - and lichen-planus like keratoses (LPLK), which corresponds to a seborrheic keratosis or a solar lentigo with inflammation and regression. The three subgroups may look different dermatoscop- ically, but we grouped them together because they are similar biologically and often reported under the same generic term histopathologically. From a dermatoscopic view, lichen planus-like keratoses are especially challeng- ing because they can show morphologic features mimicking melanoma and are often biopsied or excised for diagnostic reasons.",
